...
namespace tk2dEditor.SpriteCollectionEditor
{
	public class SettingsView	
	{
        ...
        int[] innerPadAmountValues = null;
        string[] innerPadAmountLabels = null;
		...
		public void Draw()
		{
            ...
            // initialize internal stuff
            if (innerPadAmountValues == null || innerPadAmountValues.Length == 0)
            {
                int MAX_INNER_PAD_AMOUNT = 17;
                innerPadAmountValues = new int[MAX_INNER_PAD_AMOUNT];
                innerPadAmountLabels = new string[MAX_INNER_PAD_AMOUNT];
                for (int i = 0; i < MAX_INNER_PAD_AMOUNT; ++i)
                {
                    innerPadAmountValues[i] = i;
                    innerPadAmountLabels[i] = i.ToString();
                }
            }
