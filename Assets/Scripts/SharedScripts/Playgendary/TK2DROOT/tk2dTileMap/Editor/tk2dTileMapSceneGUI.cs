...
//		p1.y = Mathf.Min(p1.y, viewRect.yMax);
	...
	public void OnSceneGUI()
	{
		...
		if (editorData.editMode == tk2dTileMapEditorData.EditMode.Paint) {
            ...
            GUILayout.BeginArea(new Rect(0, 0, sizeSceneView.x, sizeSceneView.y));
			...
			if (tk2dTileMapToolbar.scratchpadOpen) {
                GUILayout.BeginVertical(tk2dEditorSkin.GetStyle("TilemapToolbarBG"), GUILayout.Width(20), GUILayout.Height(sizeSceneView.y - 74));
