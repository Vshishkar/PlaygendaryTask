...
public class tk2dUIItemEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
		...
		btn.isOverTouchDisabled = EditorGUILayout.Toggle ("Is Move Over Enabled?", btn.isOverTouchDisabled);

		btn.soundType = (UISoundType)EditorGUILayout.EnumPopup("On click sound", btn.soundType);
